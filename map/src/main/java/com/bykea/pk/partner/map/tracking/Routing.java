...
import com.bykea.pk.partner.map.R;
...
public class Routing extends AbstractRouting {
    public static final int dropOffRoute = 1;
    public static final int pickupRoute = 2;
    public static final int onChangeRoute = 3;
    public static final int[] COLORS = new int[]{R.color.blue, R.color.colorPrimaryDark, R.color.colorPrimary, R.color.colorAccent, R.color.primary_dark_material_light};
    ...
    private Routing(Builder builder) {
        super(builder.listener, builder.routeType, builder.mContext);

...
public class CustomMapView extends MapView {
    ...
    private IViewTouchEvents mMapTouchEvents;
    ...
    public void init(GoogleMap map, IViewTouchEvents mapTouchEvents) {
        mMapTouchEvents = mapTouchEvents;
        init(map);
    }
        ...
        if (gestureDetector == null) {
            ...
            switch (ev.getAction() & MotionEvent.ACTION_MASK) {
                ...
                case MotionEvent.ACTION_UP:
                    if (mMapTouchEvents != null) {
                        mMapTouchEvents.onTouchUp();
                    }
                    fingers = 0;
                    break;
                case MotionEvent.ACTION_DOWN:
                    if (mMapTouchEvents != null) {
                        mMapTouchEvents.onTouchDown();
                    }
                    fingers = 1;
                    break;
            }

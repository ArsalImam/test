...
public class PinEntryEditText extends FontEditText {
    ...
    int[] mColors = new int[]{
            ...
            ContextCompat.getColor(getContext(), R.color.secondaryColorDark),
            ContextCompat.getColor(getContext(), R.color.textColorSecondary)
    };
...
//            mColors[2] = colorHighlight;
    ...
    /***
     *  Get color from states.
     * @param states Color drawable states.
     * @return return color value for current drawable
     */
    ...
    /**
     * Update focusable and selectable appearance for char.
     *

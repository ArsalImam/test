 ...
 */
public class ActiveHomeLoadBoardAllListAdapter extends RecyclerView.Adapter<ActiveHomeLoadBoardAllListAdapter.ViewHolder> {

    private ArrayList<LoadBoardAllListingData> mItems;
    private ItemClickListener itemClickListener;
    private Context mContext;

    public ActiveHomeLoadBoardAllListAdapter(Context context, ArrayList<LoadBoardAllListingData> items, ItemClickListener itemClickListener) {

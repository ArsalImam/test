...
public class MyRangeBar extends View {
    ...
    private MyRangeBar.OnSlideListener listener;
    ...
    public MyRangeBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
*/
    ...
    public void setOnSlideListener(MyRangeBar.OnSlideListener listener) {
...
//        animateRipple();
   ...
   /* private void animateRipple() {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        MyRangeBar.SavedState ss = new MyRangeBar.SavedState(superState);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof MyRangeBar.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        MyRangeBar.SavedState ss = (MyRangeBar.SavedState) state;
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<MyRangeBar.SavedState> CREATOR =
                new Parcelable.Creator<MyRangeBar.SavedState>() {
                    public MyRangeBar.SavedState createFromParcel(Parcel in) {
                        return new MyRangeBar.SavedState(in);
                    }

                    public MyRangeBar.SavedState[] newArray(int size) {
                        return new MyRangeBar.SavedState[size];
                    }
                };
    }

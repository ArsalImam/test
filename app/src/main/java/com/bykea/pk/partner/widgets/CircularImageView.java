...
public class CircularImageView extends ImageView {
     ...
     * @param selectorColor
     */
    private void setSelectorColor(int selectorColor) {
     ...
     */
    private void setSelectorStrokeWidth(int selectorStrokeWidth) {
     ...
     * @param
     */
    private void setSelectorStrokeColor(int selectorStrokeColor) {

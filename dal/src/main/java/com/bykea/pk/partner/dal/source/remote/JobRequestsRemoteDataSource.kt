...
class JobRequestsRemoteDataSource {
     ...
     * @param callback Callback to be executed on response from remote data source
     */
    fun getEmailUpdateRequest(emailId: String, driverId: String, token: String, callback: JobRequestsDataSource.EmailUpdateCallback) {
     ...
     * @param callback Callback to be executed on response from remote data source
     */
    fun getCheckIsEmailUpdatedRequest(driverId: String, token: String, callback: JobRequestsDataSource.EmailUpdateCheckCallback) {
